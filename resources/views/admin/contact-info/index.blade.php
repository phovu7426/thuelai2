                    ...
                    <div class="card-body">
                        <form id="contactInfoForm" method="POST" action="{{ route('admin.contact-info.store') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <x-uploads.file-upload name="pricing_background_image" label="Ảnh nền bảng giá" :value="$contactInfo->pricing_background_image ?? old('pricing_background_image')" />
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            console.log('Contact Info form loaded');
            console.log('CSRF Token:', $('meta[name="csrf-token"]').attr('content'));
            
            // Check if upload fields exist
            $('.upload-field').each(function() {
                console.log('Upload field found:', this);
