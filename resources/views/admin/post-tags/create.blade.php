...
@section('page_title', 'Thêm tag mới')
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="bi bi-tags"></i> Thêm tag mới
                        </h3>
                    </div>
                    <div class="card-body">
                        <!-- Alert messages -->
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" 
                                                  ...
                                                  placeholder="📝 Nhập mô tả tag...">{{ old('description') }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="is_active">
                                                        <i class="bi bi-check-circle"></i> Kích hoạt tag
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="submit-btn">
                                            ...
                                            <i class="bi bi-check-circle"></i> Lưu tag
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    showAlert('danger', 'Có lỗi xảy ra khi tạo tag');
                }
            },
            complete: function() {
                // Reset loading state
